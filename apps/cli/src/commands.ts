...
const COMMAND_SPECS: readonly CommandSpec[] = [
  ...
  },
  {
    name: "configure",
    synopsis:
      "configure [--summary-model gpt-5.4|gpt-5-mini|gpt-5.4-mini] [--embedding-basis title_original|title_summary|llm_key_summary] [--json]",
    ...
    examples: [
      ...
      "ghcrawl configure --embedding-basis title_original --json",
    ],
    agentJson: true,
  },
  {
  ...
  },
  {
    name: "sync",
    synopsis:
      "sync <owner/repo> [--since <iso|duration>] [--limit <count>] [--include-comments] [--include-code] [--full-reconcile] [--json]",
    ...
    examples: [
      "ghcrawl sync openclaw/openclaw --limit 1",
      "ghcrawl sync openclaw/openclaw --since 7d --json",
    ],
    agentJson: true,
  },
  {
    name: "export-sync",
    synopsis:
      "export-sync <owner/repo> [--output <path>] [--profile lean|review] [--manifest] [--body-chars <count>] [--json]",
    ...
    examples: [
      "ghcrawl export-sync openclaw/openclaw --profile lean --manifest --output ./openclaw.sync.db --json",
    ],
    agentJson: true,
  },
  {
  ...
  },
  {
    ...
    options: [
      "--portable <path>  Portable SQLite path to compare",
      "--json  Emit machine-readable JSON output explicitly",
    ],
  ...
  },
  {
    name: "refresh",
    synopsis:
      "refresh <owner/repo> [--include-code] [--no-sync] [--no-embed] [--no-cluster] [--heap-snapshot-dir <dir>] [--heap-log-interval-ms <ms>] [--json]",
    ...
    examples: [
      "ghcrawl refresh openclaw/openclaw",
      "ghcrawl refresh openclaw/openclaw --no-sync --json",
    ],
    agentJson: true,
  },
  {
  ...
  },
  {
    name: "runs",
    synopsis:
      "runs <owner/repo> [--kind sync|summary|embedding|cluster] [--limit <count>] [--json]",
    ...
    examples: [
      "ghcrawl runs openclaw/openclaw --limit 20 --json",
      "ghcrawl runs openclaw/openclaw --kind cluster --json",
    ],
    agentJson: true,
  },
  {
    name: "threads",
    synopsis:
      "threads <owner/repo> [--numbers <n,n,...>] [--kind issue|pull_request] [--include-closed] [--json]",
    ...
    examples: [
      "ghcrawl threads openclaw/openclaw --numbers 42,43,44 --json",
      "ghcrawl threads openclaw/openclaw --numbers 42 --include-closed --json",
    ],
    agentJson: true,
  },
  {
    ...
    options: [
      "--number <thread>  Thread number to close locally",
      "--json  Emit machine-readable JSON output explicitly",
    ],
  ...
  },
  {
    ...
    options: [
      "--id <cluster-id>  Cluster id to close locally",
      "--json  Emit machine-readable JSON output explicitly",
    ],
  ...
  },
  {
    ...
    synopsis:
      "exclude-cluster-member <owner/repo> --id <cluster-id> --number <thread> [--reason <text>] [--json]",
    ...
    examples: [
      'ghcrawl exclude-cluster-member openclaw/openclaw --id 123 --number 42 --reason "false positive" --json',
    ],
    agentJson: true,
  },
  {
    ...
    synopsis:
      "include-cluster-member <owner/repo> --id <cluster-id> --number <thread> [--reason <text>] [--json]",
    ...
    examples: [
      'ghcrawl include-cluster-member openclaw/openclaw --id 123 --number 42 --reason "same root cause" --json',
    ],
    agentJson: true,
  },
  {
    ...
    synopsis:
      "set-cluster-canonical <owner/repo> --id <cluster-id> --number <thread> [--reason <text>] [--json]",
    ...
    examples: [
      'ghcrawl set-cluster-canonical openclaw/openclaw --id 123 --number 42 --reason "best root issue" --json',
    ],
    agentJson: true,
  },
  {
    name: "merge-clusters",
    synopsis:
      "merge-clusters <owner/repo> --source <cluster-id> --target <cluster-id> [--reason <text>] [--json]",
    ...
    examples: [
      'ghcrawl merge-clusters openclaw/openclaw --source 123 --target 456 --reason "same root cause" --json',
    ],
    agentJson: true,
  },
  {
    name: "split-cluster",
    synopsis:
      "split-cluster <owner/repo> --source <cluster-id> --numbers <n,n,...> [--reason <text>] [--json]",
    description:
      "Split selected active members into a new durable cluster and block automatic re-entry into the source.",
    options: [
    ...
    examples: [
      'ghcrawl split-cluster openclaw/openclaw --source 123 --numbers 42,43 --reason "separate root cause" --json',
    ],
    agentJson: true,
  },
  {
    ...
    options: [
      "--number <thread>  Restrict embedding work to one thread",
      "--json  Emit machine-readable JSON output explicitly",
    ],
    examples: [
      "ghcrawl embed openclaw/openclaw --json",
      "ghcrawl embed openclaw/openclaw --number 42 --json",
    ],
    agentJson: true,
  },
  {
  ...
  },
  {
    name: "cluster",
    synopsis:
      "cluster <owner/repo> [--number <thread>] [--k <count>] [--threshold <score>] [--max-cluster-size <count>] [--heap-snapshot-dir <dir>] [--heap-log-interval-ms <ms>] [--json]",
    ...
    examples: [
      "ghcrawl cluster openclaw/openclaw --json",
      "ghcrawl cluster openclaw/openclaw --number 42 --threshold 0.82 --json",
    ],
    agentJson: true,
  },
  {
    name: "clusters",
    synopsis:
      "clusters <owner/repo> [--min-size <count>] [--limit <count>] [--sort recent|size] [--search <text>] [--hide-closed] [--json]",
  ...
  },
  {
    name: "cluster-detail",
    synopsis:
      "cluster-detail <owner/repo> --id <cluster-id> [--member-limit <count>] [--body-chars <count>] [--hide-closed] [--json]",
    ...
    examples: [
      "ghcrawl cluster-detail openclaw/openclaw --id 123 --member-limit 20 --body-chars 280 --json",
    ],
    agentJson: true,
  },
  {
    ...
    synopsis:
      "cluster-explain <owner/repo> --id <cluster-id> [--member-limit <count>] [--event-limit <count>] [--json]",
    description:
      "Explain one durable cluster with evidence, overrides, aliases, and event history.",
    options: [
    ...
    examples: [
      "ghcrawl cluster-explain openclaw/openclaw --id 123 --member-limit 20 --event-limit 50 --json",
    ],
    agentJson: true,
  },
  {
    ...
    synopsis:
      "durable-clusters <owner/repo> [--include-inactive] [--member-limit <count>] [--json]",
  ...
  },
  {
    name: "neighbors",
    synopsis:
      "neighbors <owner/repo> --number <thread> [--limit <count>] [--threshold <score>] [--json]",
  ...
  },
  {
    ...
    options: [
      "--number <thread>  Restrict summary work to one thread",
      "--include-comments  Include comments in the summary input",
    ],
    examples: [
      "ghcrawl --dev summarize openclaw/openclaw",
      "ghcrawl --dev summarize openclaw/openclaw --number 42 --include-comments",
    ],
    devOnly: true,
  },
  {
    ...
    examples: [
      "ghcrawl --dev purge-comments openclaw/openclaw",
      "ghcrawl --dev purge-comments openclaw/openclaw --number 42",
    ],
    devOnly: true,
  },
];
...
export function commandUsage(spec: CommandSpec): string {
  ...
  if (spec.agentJson) {
    lines.push(
      "",
      "Machine output:",
      "  Supports explicit --json. JSON remains the default in this compatibility pass.",
    );
  }
